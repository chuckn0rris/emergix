...
Ext.form.NewHtmlEditor = Ext.extend(Ext.form.HtmlEditor, {
	 ...
	 initComponent : function(){
		...
		this.plugins = [ new Ext.ux.form.HtmlEditor.Word(this),  new Ext.ux.form.HtmlEditor.FullScreen(this) ];
	 },
	...
	*********************************************************************************************************/								
	...
	/************************************
	this fuction will be called after focusing the editor (IN IE ONLY)
	...
	*********************************************************************************************************/
    deferKeyBinding : function(){
		...
		this.afterFocus.defer(101, this);
    },
	...
	*********************************************************************************************************/
	createHiddenDiv:function(){
		...
		if(!this.hiddenDiv){
			...
			this.hiddenDiv.setStyle({position:'absolute', top:'-100000000px',border:'1px solid #ff0000' });
		}		
	},
	...
	*********************************************************************************************************/
	updateIframeHeight:function( ){
		...
		try{
			...
			iframe.setStyle({height: this.hiddenDiv.dom.scrollHeight+'px'});
		}catch(e){
		}finally{
			return true;
		}
