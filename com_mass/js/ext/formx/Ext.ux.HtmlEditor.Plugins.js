    ...
    fixWordPaste: function(wordPaste) {
        ...
        var removals = [ /<w:[^>]*>[^<]*<\/w:[^>]*>/g,   /<\/?(meta|object)[^>]*>/ig,
			...
			/MsoNormal/g, /<\\?\?xml[^>]*>/g, /<\/?o:p[^>]*>/g, /<\/?v:[^>]*>/g, /<\/?o:[^>]*>/g, /<\/?st1:[^>]*>/g, 
             /<\/?STRONG[^>]*>/g, /<\/?font[^>]*>/g, /<\/?span[^>]*>/g, /<\/?h1[^>]*>/g, /<\/?H1[^>]*>/g, /<\/?H2[^>]*>/g, /<\/?h2[^>]*>/g, /<\/?H3[^>]*>/g,/<\/?h3[^>]*>/g, /<\/?H4[^>]*>/g,/<\/?h4[^>]*>/g, 
            /<\/?H5[^>]*>/g, /<\/?h5[^>]*>/g, /<\/?H6[^>]*>/g, /<\/?h6[^>]*>/g, /<\/?P[^>]*><\/P>/g, /<!--(.*)-->/g, /<!--(.*)>/g, /<!(.*)-->/g, /<\\?\?xml[^>]*>/g, 
            /<\/?o:p[^>]*>/g, /<\/?v:[^>]*>/g, /<\/?o:[^>]*>/g, /<\/?st1:[^>]*>/g, /lang=\"[^\"]*\"/g, 
            /lang=\'[^\"]*\'/g, /class=\"[^\"]*\"/g, /class=\'[^\"]*\'/g, /type=\"[^\"]*\"/g, /type=\'[^\"]*\'/g, /href=\'#[^\"]*\'/g, 
            /href=\"#[^\"]*\"/g, /name=\"[^\"]*\"/g, /name=\'[^\"]*\'/g, /style=\"[^\"]*\"/g, /style=\'[^\"]*\'/g, / clear=\"all\"/g, /id=\"[^\"]*\"/g, /title=\"[^\"]*\"/g, 
