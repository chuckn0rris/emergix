...
Ext.ux.membership.form.UploadFile = function(config) {
	...
	if(!config.addText)
	{
		config.addText = Ext.ux.membership.lang.browse;
	}
	
	this.inputs = new Ext.util.MixedCollection();
	
	Ext.ux.membership.form.UploadFile.superclass.constructor.call(this, config);
	
	this.addEvents({fileAdded:true});
};


Ext.extend(Ext.ux.membership.form.UploadFile, Ext.BoxComponent, {
