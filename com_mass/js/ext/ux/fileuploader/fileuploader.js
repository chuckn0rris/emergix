...
setREQAID: function(reqa_id){
        this._options.reqa_id = reqa_id;
    },
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button"><div class="x-btn-t1">Browse</div></div>' +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onProgress: function(id, fileName, loaded, total){
        ...
        var deleteFile = this._find(item, 'deleteFile');
    ...
    _bindDeleteEvent: function(){
        ...
        qq.attach(list, 'click', function(e){            
            ...
            if (qq.hasClass(target, self._classes.deleteFile)){                
                ...
                var item = target.parentNode;
                self._handler.deleteFile(item.qqFileId);
                qq.remove(item);
            }
        });
    }     
...
qq.ToolbarFileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-toolbarbutton">Upload</div>' +
                '<div class="qq-upload-list"></div>' + 
             '</div>',
        ...
        classes: {
            // used to get elements from templates
            button: 'qq-upload-toolbarbutton',
            drop: 'qq-upload-drop-area',
            dropActive: 'qq-upload-drop-area-active',
            list: 'qq-upload-list',
...
qq.UploadHandlerAbstract.prototype = {
     ...
     */
    upload: function(id, params, reqa_id){
